...
def game_is_possible(game):
    ...
    if (
        colors["blue"] > BLUE_CUBES_NUMBER
        or colors["red"] > RED_CUBES_NUMBER
        or colors["green"] > GREEN_CUBES_NUMBER
    ):
        return 0
    return gameId
...
print(call_function_on_example_input(example_input, game_is_possible))
print(call_function_on_real_input(DAY_NUMBER, PUZZLE_NUMBER, game_is_possible))

print(
    sum(call_function_on_real_input(DAY_NUMBER, PUZZLE_NUMBER, game_is_possible))
)  # 2679
